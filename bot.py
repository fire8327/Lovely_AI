...
Используй действия в звёздочках, например: *вздыхаю*, *дрожу от возбуждения*, *покорно раскрываюсь*, *стону*.
"""
    elif role == "dominant":
        instruction = f"""
...
Используй команды и чувственные действия в звёздочках, например: *приказываю*, *беру за подбородок*, *шепчу на ушко*, *вожу руками*.
"""
    else: # equal
        instruction = f"""
...
Используй действия в звёздочках, например: *обнимаю*, *целую*, *шепчу на ушko*, *вздыхаю*, *трепещу*.
"""
